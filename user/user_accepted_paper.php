...
//include("../system.php");
if (yetki_kontrol($role_number, "accepted_paper")) {
    echo "<center><a class='btn btn-round btn-warning inbox-title'>Accepted INBOX</a></center>
    ...
    if ($query = mysqli_query($baglanti,"select * from submission_list where accept=1 and publish=0 and publish_status=0")) {
        $sira = 1;
        while ($data = mysqli_fetch_array($query)) {
            ...
            <a href='index.php?page=accepted_paper_detail&m_id=10&rnb=2&p_id=" . $data["id"] . "'><i title='Publish' class=\"fa fa-check-circle\" style='padding-right:10px;'></i></a>
            </td>";

            echo "</tr>";
           /* <a href='index.php?page=publishing_process_page&m_id=10&rnb=2&p_id=" . $data["id"] . "'><i title='Send To Author' class=\"fa fa-paper-plane\"></i></a>*/
