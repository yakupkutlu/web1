...
//include("../system.php");
    ...
    echo "<center><a class='btn btn-round btn-warning inbox-title'>Sent Back To Author INBOX</a></center>
    ...
    if ($query = mysqli_query($baglanti,"select * from submission_list where  accept_status=-3 ;")) {// accept_status!=-2
        $sira = 1;
