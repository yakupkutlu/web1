    ...
    <div class="x_panel" style="min-height: 726px; margin-bottom: 0px; display: block;">
        ...
        if ($process=="revised"){ ?>
            <div style="text-align: center; margin-bottom: 30px;">
                <a href="show_paper_review_detail.php?process=revised&id=<?php echo $id; ?>" class="btn btn-round btn-primary">Paper
                    Detail</a>
                <a href="show_paper_review_detail.php?process=revised&id=<?php echo $id; ?>&page=review" class="btn btn-round btn-primary">Review
                    Decision</a>
            </div>
            <?php
        }
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            <a href="show_paper_review_detail.php?process=revised&id=<?php echo $id; ?>" class="btn btn-round btn-primary">Paper
                Detail</a>
            <a href="show_paper_review_detail.php?id=<?php echo $id; ?>&page=review&process=revised"
               class="btn btn-round btn-primary">Review
                Decision</a>
        </div>
        <?php } ?>
        <center><b><h2>UNDER REVİEW PAPER DETAIL</h2></b></center>
        </br>
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><a href="<?php echo $link;?>" target="_blank"><?php echo $paperID; ?> <img src="../images/indir.png" width="30px" heigth="30px">   <br></a></td>
            </tr>

            <tr>
                <td><a href="<?php echo $link2;?>" target="_blank">Manuscript file2</a></td>
                <td><a href="<?php echo $link2;?>" target="_blank"><?php echo $paperID; ?> <img src="../images/indir.png" width="30px" heigth="30px">   <br></a></td>
            </tr>
            <tr>
...
<?php if (isset($_GET["page"])) {
    if ($_GET["page"] == "review") { ?>
        <div class="x_panel" style="min-height: 726px; margin-bottom: 0px; display: block;">
            ...
            <center><b><h2>UNDER REVIEW DECISION</h2></b></center>
            </br>
            <?php
            if ($process=="revised"){
