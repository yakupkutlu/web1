...
$profilInfo = BilgileriGetir();  // özellikle 1 geliyor   /system.php içinde fonksiyon BilgileriGetir
...
// <form action="add_submission.php" id="add_sub_form" role="form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
 ...
 <form action="index.php?page=add_submission&m_id=26&rnb=4" id="add_sub_form" role="form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
pattern=".{3,1000}" title="Please enter valid Title"  required>
                           ...
                           <input type="hidden"   name="s_user" id="s_user"  value="<?php echo $_SESSION["user"]; ?>"   >
							...
							<br>
                                    ...
                                    <input type="radio" id="male" name="workarea" value="Natural Science" required checked>
                                    <label for="male">Natural Science</label><br>
                                    <input type="radio" id="female" name="workarea" value="Engineering Science" >
                                    <label for="Eng">Engineering Science</label> 
                                    <br> 
                                ...
                                <h2 class="StepTitle"> Being Reviewer: </h2>
                                  <h4>   <input type = "checkbox" class="icon" name="bereviewer" id="bereviewer"  required> I am  accepting to be a Reviewer in <?php echo $journalShortName; ?></h4> 
                                    ...
                                    <input type="text" name="all_authors_country" id="all_authors_country" style="display:none ">
...
-->                                                
                                    ...
                                    <h2 class="StepTitle">Upload Manuscript File* : <output id="list"></output></h2>
                                        ...
                                        <i class="fa fa-times  " style="font-size:48px;color:red"> ... </i>  The file size is greater than 5MB or İnvalid name see below "File information"
                                  ...
                                  <!--  <input type="file" name="my_file"   id="myFile"  accept=".odt, .doc, .docx, .pdf " class="rsform-upload-box" required onchange="myFunction()">
                                    --> 
                                     ...
                                     <input type="file" name="my_file"   id="myFile"  accept=".odt, .doc, .docx " class="rsform-upload-box" required onchange="myFunction()">
                                    
                                     <input type="hidden" name="MAX_FILE_SIZE" value="5000000"/>
                                        <span class="anahtar">*required</span> 
 									 	<span class="anahtar">(Upto 5 MB  word  file can be uploaded ( acceptable file format is .doc, .docx, .odt))</span><br>
 								 </div>
<hr><br>
	                                   ...
	                                   <div id="ragionfile">
                                    <h2 class="StepTitle">Upload Copyright Form * * : <output id="list"></output></h2>
                                   
                                      
                                        <div id="cross3" style = "display:none">
                                        <i class="fa fa-times  " style="font-size:48px;color:red"> ...</i>  The file size size is greater than 5MB  or İnvalid name see below "File information"
                                     ...
                                     <input type="file" name="my_abstractimage"   id="my_abstractimage"  accept=".jpg,  .pdf , .png" class="rsform-upload-box" required onchange="myFunction4()">
                                    
                                     <input type="hidden" name="MAX_FILE_SIZE" value="5000000"/>
                                        <span class="anahtar">*required</span> 
 									 	<span class="anahtar">(Upto 5 MB  image file  or pdf file can be uploaded (acceptable file format are .jpg, , .png .pdf)</span><br>
 								 </div>
<hr><br>
...
<strong><strong>Forms&nbsp;</strong></strong></span><p>&nbsp;</p><ul style="list-style-type: circle;"><li><strong><span style="font-size: medium;"><span style="color: #ff0000;"><span style="color: #ff0000; font-size: medium;"> Download the Copyright Form :&nbsp;</span><span style="font-size: medium;"> <a title="COPYRIGHT FORM" href="../journal_files/Copyright_Form.docx"> <span style="color: #0000ff;">&nbsp;WORD DOWNLOAD</span></a></span></span></span></strong></li><li><strong style="font-size: 1.17em;"><span style="font-size: medium;"><a title="Statement for the Ethics Committee Approval Form" href="../journal_files/Statement_for_the_Ethics_Committee_Approval.doc"><span style="color: #ff0000;"><strong>Statement for the Ethics Committee Approval Form  <span style="color: #0000ff;">:</span></strong><span style="color: #0000ff;">&nbsp;WORD DOWNLOAD</span></span></a></span></strong></li><li><strong><strong><span style="font-size: medium;"><a title="Ethical_Principles_and_Publication_Policy" href="../journal_files/Ethical_Principles_and_Publication_Policy.docx"><span style="color: #ff0000;"><strong>Ethical Principles and Publication Policy   :</strong> <span style="color: #0000ff;">&nbsp;WORD DOWNLOAD</span></span></a></span></strong></strong></li></ul>
<hr><br>
...
<!--
	                                   ...
	                                   <div id="ragionfile">
                                    <h2 class="StepTitle">Upload Graphical Abstract * : <output id="list"></output></h2>
                                     ...
                                     <input type="file" name="my_abstractimage"   id="my_abstractimage"  accept=".jpg, .ppt, .pptx, .pdf , .png" class="rsform-upload-box" required onchange="myFunction4()">
                                    
                                     <input type="hidden" name="MAX_FILE_SIZE" value="5000000"/>
                                        <span class="anahtar">*required</span> 
 									 	<span class="anahtar">(Upto 5 MB  image file or PPT or pdf file can be uploaded (acceptable file format are .jpg, , .png .ppt, .pptx, .pdf)</span><br>
 								 </div>
<hr><br>
...
<hr><br>
                                      ...
                                      <fieldset>
                             <legend>“Compliance with Ethical Standards” Please declare whether the results of the study involve human and/or animal rights. *:</legend>
                         <table>           
                         <tr><td  width ="25%">
...
<span class="anahtar">*required</span><br><br><br>
             ...
             <!-- no isgörünmeyeceke  alan  -->
 
 
  
 
             <!--  no isgörünmeyeceke  alan son -->
...
function myFunction4(){
  var x = document.getElementById("my_abstractimage");
  var txt = "";
   var isimhata=0;
  if ('files' in x) {
    if (x.files.length == 0) {
            ...
            <div class="modal-content animate">
                ...
                <div class="container1">
                 ...
                 <!--   
                    ...
                    <input type="text" placeholder="Enter Country" id="authors_country" required>
                    -->
                    <label><b>Country</b></label>
                        <select id="authors_country" name="authors_country" required>
                            <option value="" disabled selected>Select Country</option>
                            <?php
                            
                            if ($query = mysqli_query($baglanti, "SELECT name FROM country_list")) {
                             
                            // Eğer sorgu başarılı ise her ülke adını select menüsüne ekle
    ...
    <script>
        ...
        $BTN.click(function () {
            ...
            var authors_orcid = document.getElementById("authors_orcid").value;
             var authors_email =document.getElementById("authors_email").value
             var authors_institution =document.getElementById("authors_institution").value;
             var authors_country =document.getElementById("authors_country").value;
            
			
            var all_authors_email = document.getElementById("all_authors_email").value;
			var all_authors_orcid = document.getElementById("all_authors_orcid").value;
			var all_authors_institution = document.getElementById("all_authors_institution").value;
			var all_authors_country = document.getElementById("all_authors_country").value;
			
			 if (!author_first_name || !author_last_name || !authors_email || !authors_orcid || !authors_institution|| !authors_country) {
                    alert("Please fill in all the required fields.");
                    return false; // Formu gönderme işlemini durdur
                }else{
		    ...
		    if (all_authors_institution == "") all_authors_institution = document.getElementById("authors_institution").value;
            else all_authors_institution += "," + document.getElementById("authors_institution").value;
			
			if (all_authors_country == "") all_authors_country = document.getElementById("authors_country").value;
            else all_authors_country += "," + document.getElementById("authors_country").value;
            
			document.getElementById("all_authors_email").value = all_authors_email;
            document.getElementById("all_authors_orcid").value = all_authors_orcid;
			document.getElementById("all_authors_institution").value = all_authors_institution;
			document.getElementById("all_authors_country").value = all_authors_country;
			...
			document.getElementById("all_authors_orcid_tmp").value = document.getElementById("authors_orcid").value;
