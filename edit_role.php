...
if (yetki_kontrol($role_number, "edit_role")) {
    ...
    function add_editor_inAuthors()
    {
        ...
        } else echo "Editor eklenirken bir hata ile karşılaşıldı. <br>";
    ...
    function add_reviewer()
    {
        ...
        if (mysqli_num_rows(mysqli_query($baglanti,$sorgu2))) {
            ...
            if (mysqli_query($baglanti,"insert into users (user_name,name_surname,pass,email,role,work_area,new_user) VALUES ('$user_name','$name','$pass' ,'$email','3','$work_area','1')")) {
