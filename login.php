...
<head>
    ...
    <title> <?php echo $journalDomain ?? 'Journal Domain'; ?></title>
...
<body class="login">
 ...
 <table width="100%">
    <tbody>
        ...
        <tr><td></td><td> <center> <a href="index.php"> <img src="images/iste.png" class="image_full"/></a></center></td><td></td></tr>
    ...
    <div class="login_wrapper">
        ...
        <div class="animate form login_form">
            <section class="login_content">
                <!-- FORM BURADA SYSTEM.PHP'YE GİDİYOR -->
                <form method="post" action="system.php?system=login">
                    ...
                    <div>
                        <input size="6" maxlength="6" class="form-control" placeholder="Enter Code " name="kod" type="text" autocomplete="off" required />
                    </div>
                    <div>
                    ...
                    <div class="separator">
                        ...
                        <br />
                        <div>
                            <h1> <?php echo $journalDomain ?? 'Journal Domain'; ?> &copy; 2024</h1>
                            <p></p>
                        </div>
                    </div>
                </form>
            ...
            <section class="login_content">
                <form method="post" action="system.php?system=new_user">
                    ...
                    <div class="form-group">
                        <select class="select2_single form-control" tabindex="-1" name="unvan" required>
                    ...
                    <div><input type="text" class="form-control" placeholder="Your Name" name="name" required="" /></div>
                    <div><input type="text" class="form-control" placeholder="Your Surname" name="surname" required="" /></div>
                    <div><input type="email" class="form-control" placeholder="Email" name="email"  required="" /></div>
                    <div><input type="password" class="form-control" placeholder="Password" name="pass"  required="" /></div>
                    <div><input type="password" class="form-control" placeholder="Again Password" name="pass_again"  required="" /></div>
                    <div><textarea style="margin-bottom: 20px; resize: none;" name="adress" class="form-control" rows="3" placeholder="Adress" required></textarea></div>
                    <div><input type="text" class="form-control" placeholder="Instition" name="instition"  required="" /></div>
                    <div><input type="text" class="form-control" placeholder="ORCID Number" name="orcid_no"  required="" /></div>
                    <div><input type="text" class="form-control" placeholder="Phone" name="phone"  required="" /></div>
                    <div><input type="text" class="form-control" placeholder="work area *** Please separate with comma  ***" name="work_area"  required="" /></div>
                    <img src="img.php" width="150" height="50"> <br>                  
                    <div>
