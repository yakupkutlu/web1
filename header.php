...
<script type="application/ld+json">
{
  ...
  "@type": "WebSite",
  "url": "http://www.journalner.com/",
  "name": "journalner",
  "description": "It  is a journal platform for publishing scientific research articles."
}
</script>
...
<script>
  ...
  gtag('config', 'G-SHBBPLGEJW');
   ...
   ?>
    <title><?php echo preg_replace('/<[^>]*>/', '', $journalName);
   ?></title>
...
<div class="top-bar">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-122">
                            <div class="logo">
                                <a href="index.php">
                                      <center>   <img   width="70%"  src="./img/jner_header.png" alt="">
                                    </center> 
                                </a>
                            </div>
                        </div>
          ...
          <!--      <img style="mergin-left:30%; margin-top:80px" class="img-fluid" src="./_jaiwa_logo.png" alt=""> -->
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
				 ...
				 <a title="content " href="index.php?page=login" class="btn btn-secondary py-sm-3 px-sm-5  me-3">Login/Register</a>
            </div>
        </nav>
        <!-- Navbar End -->
